...
var NotFound = require('/Users/user18/baishu_front/KPI/mhc_ant_Admin/site/theme/template/NotFound');
var themeConfig = JSON.parse('{"typeOrder":{"Layout":1,"Navigation":2,"Data Entry":3,"Data Display":4,"Other":5}}');
...
module.exports = function getRoutes(data) {
  function templateWrapper(template) {
    ...
    var Template = require('/Users/user18/baishu_front/KPI/mhc_ant_Admin/site/theme/template' + template.replace(/^\.\/template/, ''));
  ...
  var themeRoutes = JSON.parse('[{"path":"/","component":"./template/Home"},{"path":"/changelog","component":"./template/Doc"},{"path":"/docs/:doc","component":"./template/Doc"},{"path":"/components/:doc","component":"./template/Doc"},{"path":"/404","component":"./template/NotFound"}]');
