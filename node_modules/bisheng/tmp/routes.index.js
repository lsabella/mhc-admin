...
var NotFound = require('/Users/user18/baishu_front/KPI/mhc-admin/site/theme/template/NotFound');
...
module.exports = function getRoutes(data) {
  function templateWrapper(template) {
    ...
    var Template = require('/Users/user18/baishu_front/KPI/mhc-admin/site/theme/template' + template.replace(/^\.\/template/, ''));
